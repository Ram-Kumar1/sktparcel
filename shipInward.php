                                        ...
                                        <table class="table tableFixHead table-striped table-hover" id="data-table">
                                            <thead>
                                                <tr class="filters" style="color:#0c1211;">
                                                    ...
                                                    <th style="color:#0c1211">Delivery</th>
                                                    <th style="color:#0c1211">From</th>
                                                    <th style="color:#0c1211">From Address</th>
                                                    <th style="color:#0c1211">To</th>
                                                    <th style="color:#0c1211">To&nbsp;Address</th>
                                            ...
                                            ?>
                                                <tbody>
                                                    <tr class="invoice-id-<?php echo $row['BOOKING_ID']; ?>">
                                                        ...
                                                        <td class="max-30" style="color:#0c1211">
                                                            <a data-toggle="modal" onclick="updateToShipinCancel(<?php echo $row['BOOKING_ID']; ?>)" id="move-booking-id-<?php echo $row['BOOKING_ID']; ?>" data-booking-id="<?php echo $row['BOOKING_ID']; ?>" href="">
...
<script>
    let updateToShipinCancel = function (bookingId) {
        $.ajax({
